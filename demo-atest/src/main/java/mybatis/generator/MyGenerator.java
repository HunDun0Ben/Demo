...
//                                        .disableOpenDir() // 禁止自动打开跳转输出目录, 只会跳转到 outputDir
                ...
                .strategyConfig((scanner, builder) ->
                        ...
                        .serviceBuilder()
                                .convertServiceFileName(entityName -> entityName + "Facade")
                                .convertServiceImplFileName(entityName -> entityName + "FacadeImpl")
                                .superServiceClass("")
    ...
    protected static String replaceJavaPath(OutputFile file, String base, String module) {
        String javaPath = "E:/workspace/project/demo123/{project}/src/main/java{base}{type}{module}";
    ...
    protected static String replaceResource(OutputFile file, String module){
        String resourcePath = "E:/workspace/project/demo123/{project}/src/main/resources{type}{module}";
        String type = StringUtils.isBlank(map.get(file)) ? "" : "/" + map.get(file);
        module = StringUtils.isBlank(module) ? "" : "/" + module;
